      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <button onClick={() => scrollToSection('process')} className="text-gray-300 hover:text-cyan-400 transition-colors">
              Process
            </button>
            ...
            <button
              ...
              className="px-6 py-2.5 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-lg font-semibold text-white hover:scale-105 hover:shadow-lg hover:shadow-cyan-500/50 transition-all"
            >
              Start the Process
            </button>
          </div>
